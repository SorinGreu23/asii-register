export function MyCustomCard({ Icon, title, content }) {
  return (
    <button className="w-56 p-6 bg-white rounded-lg shadow-lg flex flex-col items-center cursor-pointer hover:bg-gray-100 transition duration-300">
      ...
      <button className="text-red-primary border-2 border-red-primary rounded-lg 
              hover:bg-red-primary hover:text-white transition duration-300 px-4 py-2 cursor-pointer">See more</button>
    </button>
  );
}